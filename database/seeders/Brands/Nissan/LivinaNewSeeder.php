...
class LivinaNewSeeder extends Seeder
{
        ...
        $typeConfigurations = [
            'EL' => [
                'generations' => [
                    '2019-Now (Gen 3)' => [
                        'engine' => [
                            ['cc' => 1500, 'code' => '4A91', 'fuel_type' => 'Bensin',
                             'transmission' => ['MT'], 'power' => 104, 'torque' => 141]
                        ]
                    ]
                ]
            ],
            'VE' => [
                'generations' => [
                    '2019-Now (Gen 3)' => [
                        'engine' => [
                            ['cc' => 1500, 'code' => '4A91', 'fuel_type' => 'Bensin',
                             'transmission' => ['AT'], 'power' => 104, 'torque' => 141]
                        ]
                    ]
                ]
            ],
    ...
    {
        return match (true) {
            str_contains($period, '2019-Now') => range(2019, $currentYear),
            default => []
        };
    }
        ...
        $fuelType, $power, $torque, $generation): string
    {
        ...
        return "Nissan Livina {$typeName} {$engineSize} {$transText} {$fuelType} "
             ...
             . "Generasi {$generation}, hasil kolaborasi Nissan & Mitsubishi berbasis Xpander.";
    }
}
