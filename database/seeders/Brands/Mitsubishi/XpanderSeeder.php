...
class XpanderSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($xpanderTypes as $typeData) {
    ...
    {
        if (str_contains($period, '2017-2023')) {
            return range(2017, 2023);
        }
        return [];
    }
    ...
    private function generateDescription($typeName, $year, $cc, $engineCode, $transmission, $fuelType, $power, $torque, $generation): string
    {
        ...
        return "Mitsubishi Xpander {$typeName} {$ccText} {$transmissionText} {$fuelType} ({$power}, {$torque} Nm) tahun {$year}. Generasi {$generation}, MPV keluarga dengan desain stylish dan kenyamanan maksimal.";
    }
}
