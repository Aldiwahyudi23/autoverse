...
class GrandVitaraSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        foreach ($grandVitaraTypes as $typeData) {
    ...
    private function generateDescription($typeName, $year, $cc, $engineCode, $transmission, $fuelType, $generation, $power): string
    {
        ...
        $specialFeatures = " Dikenal sebagai SUV tangguh dan nyaman.";
        if ($typeName === 'Hybrid') {
            $specialFeatures = " Varian hybrid terbaru dengan teknologi Smart Hybrid Vehicle by Suzuki (SHVS).";
        }

        return "Suzuki Grand Vitara {$typeName} {$ccText} {$engineCode} {$transmissionText} {$fuelText} tahun {$year}. " .
               "Generasi {$generation} dengan tenaga {$power}. Kendaraan {$bodyType} yang nyaman dan tangguh.{$specialFeatures}";
    }
