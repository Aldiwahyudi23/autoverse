...
class JimnySeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        foreach ($jimnyTypes as $typeData) {
    ...
    private function generateDescription($typeName, $year, $cc, $engineCode, $transmission, $fuelType, $generation, $power): string
    {
        ...
        $specialFeatures = " Dikenal dengan kemampuannya di medan off-road.";
        if ($typeName === '5-Door') {
            $specialFeatures = " Varian dengan lima pintu yang lebih praktis untuk keluarga.";
        }

        return "Suzuki Jimny {$typeName} {$ccText} {$engineCode} {$transmissionText} {$fuelText} tahun {$year}. " .
               "Generasi {$generation} dengan tenaga {$power}. Mobil {$bodyType} yang ikonik dan tangguh.{$specialFeatures}";
    }
