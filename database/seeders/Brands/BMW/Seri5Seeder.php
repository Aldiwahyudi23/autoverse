...
class Seri5Seeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        foreach ($seri5Types as $typeData) {
    ...
    private function generateDescription($typeName, $year, $cc, $power, $fuelType, $generation): string
    {
        ...
        $bodyType = "Sedan";
        $specialFeatures = " Dikenal sebagai sedan eksekutif mewah dengan performa seimbang, kenyamanan, dan teknologi tinggi.";

        if ($typeName === 'M5') {
            $specialFeatures = " Varian performa tinggi dari Seri 5, dikenal sebagai sedan sport mewah dengan performa layaknya supercar.";
        }

        return "BMW Seri 5 {$typeName} {$ccText} {$fuelText} tahun {$year}. " .
