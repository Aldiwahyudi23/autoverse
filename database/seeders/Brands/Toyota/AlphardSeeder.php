...
class AlphardSeeder extends Seeder
{
    ...
    public function run(): void
    {
                    ...
                    '2015-Sekarang' => [
                        'engine' => [
                            [
                                ...
                                'engine_code' => '2AR-FXE',
                                'transmission' => ['e-CVT'],
                                'power' => '150 HP (mesin) + 141 HP (motor listrik)'
                            ],
                        ]
                    ],
                ]
        ...
        foreach ($alphardTypes as $typeData) {
    ...
    private function generateDescription($typeName, $year, $cc, $engineCode, $transmission, $fuelType, $generation, $power): string
    {
        ...
        $specialFeatures = " Dikenal dengan kenyamanan dan fitur mewahnya.";
        if ($typeName === 'Hybrid') {
            $specialFeatures = " Varian Hybrid dengan sistem e-CVT untuk efisiensi bahan bakar yang lebih baik.";
        }

        return "Toyota Alphard {$typeName} {$ccText} {$engineCode} {$transmissionText} {$fuelText} tahun {$year}. " .
