...
class VellfireSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($vellfireTypes as $typeData) {
    ...
    private function generateDescription($typeName, $year, $cc, $engineCode, $transmission, $fuelType, $generation, $power): string
    {
        ...
        return "Toyota Vellfire {$typeName} {$ccText} {$engineCode} {$transmissionText} {$fuelText} tahun {$year}. " .
               "Generasi {$generation} dengan tenaga {$power}. Kendaraan {$bodyType} premium yang dikenal dengan desainnya yang stylish dan fitur kenyamanan mewah.";
    }
