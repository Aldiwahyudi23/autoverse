  ...
  >
    <div class="space-y-4">
      ...
      <div v-if="point.input_type === 'imageTOradio'" class="mt-2">
        ...
        <!-- Radio/Checkbox Options for ImageToRadio -->
      ...
      <!-- Radio/Checkbox Options for Radio -->
      <div v-if="point.input_type === 'radio' && options.length"
        class="grid gap-2 w-full mt-2"
        :class="`grid-cols-${Math.min(options.length, 3)}`"
      >
        <label
      ...
      <div v-if="showTextarea && textareaSettings" class="space-y-2">
        ...
        />
        <p v-if="textareaSettings.textarea_is_required !== false && !notesValue" class="text-xs text-red-500">
