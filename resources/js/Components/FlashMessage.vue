      ...
      <div class="flex p-4">
        ...
        <div class="ml-4 flex-shrink-0 flex">
          <button
            ...
            :class="{
              'focus:ring-green-500 text-green-500 hover:text-green-600': type === 'success',
              'focus:ring-red-500 text-red-500 hover:text-red-600': type === 'error',
              'focus:ring-blue-500 text-blue-500 hover:text-blue-600': type === 'info',
              'focus:ring-yellow-500 text-yellow-500 hover:text-yellow-600': type === 'warning',
            }"
          >
